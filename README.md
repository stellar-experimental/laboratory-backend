...
> Note: PRs on this repository are reviewed in parallel by a swarm of
> specialist Claude agents covering Postgres, TypeScript, Docker,
> security, and documentation. See `.github/workflows/claude-review.yml`.
